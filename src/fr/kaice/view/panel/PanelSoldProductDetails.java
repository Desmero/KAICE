...
public class PanelSoldProductDetails extends JPanel implements Observer {
    ...
    public PanelSoldProductDetails(SoldProduct product) {
        ...
        qty = new JLabel("Quantit� : " + product.getQuantity());
        price = new JLabel("Prix : " + DMonetarySpinner.intToString(product.getPrice()));
        cost = new JLabel("Co�t : " + DMonetarySpinner.intToString(product.getBuyPrice()));
        profit = new JLabel("B�n�fice : " + DMonetarySpinner.intToString(product.getProfit()));
    ...
    public void update(Observable o, Object arg) {
        if (KaiceModel.isPartModified(KaiceModel.SOLD_PRODUCT)) {
            ...
            qty.setText("Quantit� : " + product.getQuantity());
            price.setText("Prix : " + DMonetarySpinner.intToString(product.getPrice()));
            cost.setText("Co�t : " + DMonetarySpinner.intToString(product.getBuyPrice()));
            profit.setText("B�n�fice : " + DMonetarySpinner.intToString(product.getProfit()));
