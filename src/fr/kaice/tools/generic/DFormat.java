...
public abstract class DFormat {
     ...
     * Example : "ven. 26/08"
     */
    public static final SimpleDateFormat DATE_YEAR_LESS = new SimpleDateFormat("E dd/MM");
     ...
     * Example : "14:48"
     */
    public static final SimpleDateFormat HOUR_ONLY = new SimpleDateFormat("HH:mm");
    /**
